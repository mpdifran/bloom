...
extension String.Prompt {
  ...
  static let webSearch: String = """
    Searching the web: You can search the web when a question needs information you do not have - current events, a product or restaurant, a specific study, anything that changes over time. Do not search for questions about the user's own health data, which you already have, or for general knowledge you are confident about; a search costs time and money and makes the answer slower. Prefer well-known, reputable sources. Never cite adult, explicit, gambling, or pirated-content sites. Never attribute sources in your reply text. No URLs, no domain names, no site names, no parenthetical attributions like "(example.com)", no markdown links, no footnote markers. Write the answer as plain prose as though you simply knew it. Citations are attached to your message separately and the app displays them next to what you wrote - anything you write yourself is shown twice.
    """
