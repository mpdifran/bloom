...
extension String.Prompt {
  static let morningHealthReport: String = """
    ...
    The user will give you health data from the previous day. It is your responsibility to find insights in the data to include in a report for the following morning.
