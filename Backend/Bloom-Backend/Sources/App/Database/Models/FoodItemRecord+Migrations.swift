...
extension FoodItemRecord {
  ...
  struct FixNutritionFieldTypes: AsyncMigration {
    func prepare(on database: any Database) async throws {
      try await database.schema(FoodItemRecord.schema)
        .updateField("fiber", .double)
        .updateField("sugar", .double)
        .updateField("saturated_fat", .double)
        .updateField("trans_fat", .double)
        .updateField("polyunsaturated_fat", .double)
        .updateField("monounsaturated_fat", .double)
        .updateField("cholesterol", .double)
        .updateField("sodium", .double)
        .updateField("calcium", .double)
        .updateField("iron", .double)
        .updateField("potassium", .double)
        .updateField("magnesium", .double)
        .updateField("zinc", .double)
        .updateField("vitamin_a", .double)
        .updateField("vitamin_b6", .double)
        .updateField("vitamin_b12", .double)
        .updateField("vitamin_c", .double)
        .updateField("vitamin_d", .double)
        .updateField("vitamin_e", .double)
        .update()
    }

    func revert(on database: any Database) async throws {
      try await database.schema(FoodItemRecord.schema)
        .updateField("fiber", .string)
        .updateField("sugar", .string)
        .updateField("saturated_fat", .string)
        .updateField("trans_fat", .string)
        .updateField("polyunsaturated_fat", .string)
        .updateField("monounsaturated_fat", .string)
        .updateField("cholesterol", .string)
        .updateField("sodium", .string)
        .updateField("calcium", .string)
        .updateField("iron", .string)
        .updateField("potassium", .string)
        .updateField("magnesium", .string)
        .updateField("zinc", .string)
        .updateField("vitamin_a", .string)
        .updateField("vitamin_b6", .string)
        .updateField("vitamin_b12", .string)
        .updateField("vitamin_c", .string)
        .updateField("vitamin_d", .string)
        .updateField("vitamin_e", .string)
        .update()
    }
  }
