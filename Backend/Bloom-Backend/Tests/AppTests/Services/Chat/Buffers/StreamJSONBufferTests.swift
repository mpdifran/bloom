...
struct StreamJSONBufferTests {
  ...
  @Test(arguments: [
    ...
    ("```json{}```Hello", 2, [1, 2, 2, 2], ["{}", "He", "ll", "o"]),
    ("```json{\"test\": 1}```", 2, [1], ["{\"test\": 1}"]),
    ("12```json{\"test\": 1}```\n\n```json{\"test\": 2}```34", 2, [1, 2, 3, 4], ["12", "{\"test\": 1}", "{\"test\": 2}", "34"])
  ])
  ...
  @Test(arguments: [
    ...
    ("```json{\"test\": 1}```Hello", [1, 2], ["{\"test\": 1}", "Hello"]),
    ("```json{\"test\": 1}```", [1], ["{\"test\": 1}"]),
    ("12```json{\"test\": 1}```\n\n```json{\"test\": 2}```34", [1, 2, 3, 4], ["12", "{\"test\": 1}", "{\"test\": 2}", "34"])
  ])
