...
final class HealthGoalProvider: Sendable {
    static let shared = HealthGoalProvider()
...
extension HealthGoalProvider {
    ...
    func recommendedDailyIntakeForVitaminA() async -> HKQuantityRange? {
        guard let age = healthStore.age() else { return nil }
    ...
    func recommendedDailyIntakeForVitaminB6() async -> HKQuantityRange? {
        guard let age = healthStore.age() else { return nil }
    ...
    /// unit: mcg
    /// - note: https://www.canada.ca/en/health-canada/services/food-nutrition/healthy-eating/dietary-reference-intakes/tables/reference-values-vitamins.html
    func recommendedMinDailyIntakeForVitaminB12() async -> HKQuantity? {
        guard let age = healthStore.age() else { return nil }
    ...
    /// unit: mg
    /// - note: https://www.canada.ca/en/health-canada/services/food-nutrition/healthy-eating/dietary-reference-intakes/tables/reference-values-vitamins.html#tbl2
    func recommendedDailyIntakeForVitaminC() async -> HKQuantityRange? {
        guard let age = healthStore.age() else { return nil }
    ...
    /// unit: mcg
    /// - note: https://www.canada.ca/en/health-canada/services/food-nutrition/healthy-eating/dietary-reference-intakes/tables/reference-values-vitamins.html
    func recommendedDailyIntakeForVitaminD() async -> HKQuantityRange? {
        guard let age = healthStore.age() else { return nil }
    ...
    /// unit: mg
    /// - note: https://www.canada.ca/en/health-canada/services/food-nutrition/healthy-eating/dietary-reference-intakes/tables/reference-values-vitamins.html
    func recommendedDailyIntakeForVitaminE() async -> HKQuantityRange? {
        guard let age = healthStore.age() else { return nil }
    ...
    func recommendedIntakeForCalcium() async -> HKQuantityRange? {
        guard let age = healthStore.age() else { return nil }
    ...
    func recommendedDailyIntakeForIron() async -> HKQuantityRange? {
        guard let age = healthStore.age() else { return nil }
    ...
    func recommendedDailyIntakeForMagnesium() async -> HKQuantityRange? {
        guard let age = healthStore.age() else { return nil }
    ...
    func recommendedDailyIntakeForPotassium() async -> HKQuantityRange? {
        guard let age = healthStore.age() else { return nil }
    ...
    func recommendedDailyIntakeForZinc() async -> HKQuantityRange? {
        guard let age = healthStore.age() else { return nil }
