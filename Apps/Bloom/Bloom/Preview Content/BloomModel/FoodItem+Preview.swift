...
extension FoodItem.Preview {
  ...
  static let grilledSalmon = FoodItem(
    ...
    flavour: nil,
    country: .canada,
    calories: .init(value: 280, unit: "kcal"),
    protein: nil,
    carbohydrates: nil,
    fat: nil,
    saturatedFat: nil,
    ...
    servingQuantity: .init(value: 150, unit: "g"),
    ingredients: nil,
    category: .generic,
    isVerified: false
  )
  ...
  static let mixedLettuce = FoodItem(
    ...
    flavour: nil,
    country: .canada,
    calories: .init(value: 30, unit: "kcal"),
    protein: nil,
    carbohydrates: nil,
    fat: nil,
    saturatedFat: nil,
    ...
    vitaminE: nil,
    servingName: "1 Bowl",
    servingQuantity: .init(value: 100, unit: "g"),
    ingredients: nil,
    category: .generic,
    isVerified: false
  )
  ...
  static let slicedCarrots = FoodItem(
    ...
    flavour: nil,
    country: .canada,
    calories: .init(value: 10, unit: "kcal"),
    protein: nil,
    carbohydrates: nil,
    fat: nil,
    saturatedFat: nil,
    ...
    servingQuantity: .init(value: 15, unit: "g"),
    ingredients: nil,
    category: .generic,
    isVerified: false
  )
  ...
  static let cherryTomatoes = FoodItem(
    ...
    flavour: nil,
    country: .canada,
    calories: .init(value: 40, unit: "kcal"),
    protein: nil,
    carbohydrates: nil,
    fat: nil,
    saturatedFat: nil,
    ...
    servingQuantity: .init(value: 45, unit: "g"),
    ingredients: nil,
    category: .generic,
    isVerified: false
  )
