...
public enum SchemaV27: VersionedSchema {
  public static let versionIdentifier = Schema.Version(0, 27, 0)

  public static let models: [any PersistentModel.Type] = [
    SchemaV17.BowelMovement.self,
    SchemaV27.ChatMessage.self,
    SchemaV27.ChatConversation.self,
