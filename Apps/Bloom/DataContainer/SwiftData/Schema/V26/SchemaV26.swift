...
public enum SchemaV26: VersionedSchema {
  public static let versionIdentifier = Schema.Version(0, 26, 0)

  public static let models: [any PersistentModel.Type] = [
    SchemaV17.BowelMovement.self,
    SchemaV26.ChatMessage.self,
    SchemaV26.ChatConversation.self,
